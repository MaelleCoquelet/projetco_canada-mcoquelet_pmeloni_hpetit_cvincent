    ...
    <section class="col-span-12 grid grid-cols-12 text-white bg-red-900">
        <div class="col-start-3 col-end-11 mt-16 mb-16">
            ...
            <div class=" flex p-6 bg-white/10 items-center rounded-lg mt-5">
                ...
                <p class=" text-xl ml-9 font-semibold text-left">Un cadre naturel exceptionnel – Paysages québécois
            ...
            <div class=" flex p-6 bg-white/10 items-center rounded-lg mt-5">
                ...
                <p class=" text-xl ml-9 font-semibold text-left">Vie Québécoise authentique – Matane offre une immersion
            ...
            <div class=" flex p-6 bg-white/10 items-center rounded-lg mt-5">
                ...
                <p class=" text-xl ml-9 font-semibold text-left">Activités locales – Feux de camp, pêche au saumon,
    ...
    <section class="col-span-12 grid grid-cols-12 text-black bg-red-100">
        <div class="col-start-3 col-end-11 mt-16 mb-16 -z-10">
            ...
            <div class="relative">
                ...
                <p class="ml-16 text-lg">Que ce soit sur le plan académique ou personnel, il faut se rappeler que c’est
            ...
            <div class="relative mt-10">
                <p class="text-9xl absolute top-0 left-0 text-red-900 opacity-25">“</p>
                <p class="ml-16 text-lg">La générosité et l’accueil des québécois était particulièrement appréciable. De
