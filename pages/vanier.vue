...
<template>
    <section class="md:col-span-12 md:grid md:grid-cols-12 p-8 bg-[url(/img/vanier.jpg)]">
    ...
    <section class="md:col-span-12 md:grid md:grid-cols-12 text-white bg-red-900 p-8">
        <div class="flex flex-col gap-6 md:col-start-3 md:col-end-11 md:mt-16 md:mb-16">
            <h4 class="text-2xl md:text-3xl font-semibold">Qu'est-ce que le Cegep de Vanier ?</h4>
            <p class="text-lg mt-5">Vanier College est l'un des 48 cégeps au Québec, fondé en 1970 dans le quartier
                Saint-Laurent à Montréal. Il tire son nom de Georges-Philias Vanier, un Canadien de renom qui fut le
                premier gouverneur général francophone du Canada. Son histoire est profondément ancrée dans l'objectif
                de promouvoir l'éducation bilingue, la diversité et l'ouverture culturelle, des valeurs qui restent au
                cœur de sa mission aujourd'hui.</p>

            <p class="text-lg mt-5">L'IUT de Nord Franche-Comté et Vanier College collaborent dans le cadre d'échanges
                académiques internationaux. Ce partenariat permet aux étudiants d'élargir leurs compétences, de
                découvrir des approches pédagogiques différentes, et de développer une ouverture culturelle. Il favorise
                également les échanges dans les domaines de la communication, du multimédia, et de la programmation.</p>

            <!-- Cards (ça prend de la place avec les svg sorry) -->

            <h4 class="text-2xl md:text-3xl font-semibold">Pourquoi on aime tant Vanier ?</h4>
            <div class="flex gap-2 p-6 bg-white/10 items-center rounded-lg">
                ...
                <p class="text-base md:text-xl font-semibold text-left">Situé dans un environnement urbain dynamique proposant
                    un large
                    panel d’activités culturelles.</p>
            </div>
            ...
            <div class="flex gap-2 p-6 bg-white/10 items-center rounded-lg">
                ...
                <p class="text-base md:text-xl font-semibold text-left">Un campus et des installations dédiés au multimédia et
                    situés juste
                    à côté du métro. </p>
            </div>
            ...
            <div class="flex gap-2 p-6 bg-white/10 items-center rounded-lg">
                ...
                <p class="text-base md:text-xl font-semibold text-left">Aborde de nombreux sujets tels que l’animation, le
                    développement de jeux, ou le design du son. </p>
            </div>
    ...
    <section class="md:col-span-12 md:grid md:grid-cols-12 text-black bg-red-100 p-8">
        <div class="md:col-start-3 md:col-end-11 md:mt-16 md:mb-16">
            ...
            <div class="relative">
                ...
                <p class="ml-10 md:ml-16 text-lg">Le système Canadien est centré autour de la pratique, on ne fait que
                    des
                    projets. La notation est gentille ce qui permet de se concentrer sur notre travail et le mettre dans
                    notre portfolio.
                    La relation avec les professeurs est aussi beaucoup moins “scolaire”, on peut organiser des sorties
                    avec eux si on le souhaite.”</p>
                <p class="ml-10 md:ml-16 font-bold text-right">Hugo PETIT</p>
            ...
            <div class="relative mt-10">
                <p class="text-9xl absolute top-0 -left-5 text-red-900 opacity-25">“</p>
                <p class="ml-10 md:ml-16 text-lg">C’était mon rêve d’aller au Canada parce que depuis petite je veux
                    vivre dans
                    un pays anglophone [...] financièrement c’était compliqué mais j’ai adoré être au Canada. [...] Les
                    profs sont vraiment trop sympas et on a pu remplir notre portfolio à fond.”</p>
                <p class="ml-10 md:ml-16 font-bold text-right">Paola MELONI</p>
                <p class="ml-10 md:ml-16 text-right">échange de août à décembre 2024</p>
            </div>
        </div>
    </section>
